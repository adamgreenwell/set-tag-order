...
1. Go to **Settings → Set Tag Order**, or use the **Settings** link on the plugin's row on the Plugins screen.
...
3. Put the tags in the order you want — arrow buttons in either editor, or drag and drop in the Classic Editor. **Sort A–Z** re-sorts the list alphabetically.
